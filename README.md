...
```
        <figure>
          <img src="https://cdn.freecodecamp.org/curriculum/cat-photo-app/lasagna.jpg" alt="A slice of lasagna on a plate.">
          <figcaption>Cat love lasagna.</figcaption>
        </figure>
```
27.
```
...
This is the next courses on responsive web design. This course have different link with cat photo app, i will show the link below:
```
https://www.freecodecamp.org/learn/2022/responsive-web-design/learn-basic-css-by-building-a-cafe-menu/step-[changenumber]
```
1.
```
<!DOCTYPE html>
